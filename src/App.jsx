  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center text-white">
      <article className="w-[350px] rounded-[15px] bg-card-blue-900 p-card-300">
        ...
        <h1 className="mb-card-200">Equilibrium #3429</h1>
        <p className="mb-card-300 text-card-blue-500">
        ...
        <div className="mb-card-300 flex justify-between">
          <figure className="flex items-center gap-card-100">
            ...
            <figcaption className="text-card-cyan-400">0.041 ETH</figcaption>
          </figure>
          <figure className="flex items-center gap-card-100">
            <img src={iconClock} alt="Clock" />
            <figcaption className="text-card-blue-500">3 days left</figcaption>
          </figure>
        </div>
        ...
        <figure className="flex items-center gap-card-200">
          ...
          />
          <figcaption className="flex gap-card-100 text-card-blue-500">
